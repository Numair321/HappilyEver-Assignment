...
const Page3 = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-start gap-6 p-4 bg-gradient-to-r from-violet-500 to-fuchsia-500 shadow-md rounded-md">
